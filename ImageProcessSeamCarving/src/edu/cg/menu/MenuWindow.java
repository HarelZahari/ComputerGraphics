...
public class MenuWindow extends JFrame implements Logger {
    ...
    public void gradientMagnitude() {
        BufferedImage img = new ImageProcessor(this, duplicateImage(), colorMixer.getRGBWeights()).gradientMagnitude();
    ...
    public void resize() {
        ...
        case BILINEAR:
            img = new ImageProcessor(this, duplicateImage(), rgbWeights, outWidth, outHeight).bilinear();
            break;
