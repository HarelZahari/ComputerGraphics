...
public class AdvancedSeamsCarver extends BasicSeamsCarver {
    ...
    public AdvancedSeamsCarver(Logger logger, BufferedImage workingImage, int outWidth, int outHeight, RGBWeights rgbWeights) {
    ...
    public BufferedImage resizeWithSeamCarving(CarvingScheme carveScheme) {
        ...
        if (this.outWidth <= this.inWidth && this.outHeight <= this.inHeight) {
            ...
            // TODO: Implement the additional seam carving functionalities that
            // AdvancedSeamsCarver offers.
