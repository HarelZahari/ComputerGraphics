...
public final class Specification {
    ...
    // Window:
    public static final double WINDOW_DEPTH = 1;
    public static final double WINDOW_HEIGHT = 1;
    public static final double WINDOW_WIDTH = 1;

    // Door:
    public static final double DOOR_DEPTH = 1;
    public static final double DOOR_WIDTH = 1;
    public static final double DOOR_HEIGHT = 1;

    // Step:
    public static final double STEP_DEPTH = 1;
    public static final double STEP_WIDTH = 1;
    public static final double STEP_HEIGHT = 1;

    // Exhaust:
    public static final double EXHAUST_RADIUS = 1;
    public static final double EXHAUST_DEPTH = 1;
