...
import edu.cg.models.Locomotive.Window;
 ...
 */
public class Viewer {
    private double zoom = 1.0; // How much to zoom in? >0 mean come closer, <0 means get back
    ...
    public void reshape(int x, int y, int width, int height) {
        ...
        Project.gluPerspective(viewAngle, aspect, 1, 1000);
    }
